...
const Akshar = () => {
  return (
    <div>
      ...
      <Layout2 content="Unnati Welfare Society has launched a transformative program called &quot;Akshar&quot;, dedicated to teaching English to children in rural villages. Conducted on weekends in open spaces, this initiative aims to create an inclusive environment where every child, regardless of background, gains the ability to read, write, and communicate in English. By leveraging innovative teaching methods and engaging activities, &quot;Akshar&quot; not only enhances language skills but also boosts confidence and inspires a love for learning. This grassroots effort ensures that education reaches the underserved, empowering them with essential skills to thrive in a globalized world while fostering a spirit of community learning." bg3="#D9ECEC" color="#008080"  image3="./Polygon-2.png"/>

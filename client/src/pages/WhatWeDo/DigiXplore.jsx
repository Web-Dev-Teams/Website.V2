...
`}
        ...
        <Layout7
          name="Mukesh"
          name2="Rakesh"
          contPara1={`Mukesh, a boy from a village, joined the "Akshar" English program at Unnati Welfare Society. Through consistent`}
          contPara2={` weekend classes, he overcame language barriers and now confidently speaks and writes English, marking a remarkable transformation in his life.`}
          image="./pic1.png"
          image2="./pic2.png"
          cont2Para1={`Rakesh, a boy from a village, joined the "Akshar" English program at Unnati Welfare Society. Through consistent`}
          cont2Para2={`weekend classes, he overcame language barriers and now confidently speaks and writes English, marking a remarkable transformation in his life.`}
          color="#AC63E0"
        />
